...
module DFT
  ...
  input   reset_x;
  input   enb;
  input   signed [14:0] dataIn;  // sfix15_En5
  input   validIn;
  output  signed [14:0] dataOut_re;  // sfix15_En5
  output  signed [14:0] dataOut_im;  // sfix15_En5
  output  validOut;

  wire softReset;
  wire signed [14:0] dataIn_1_cast_re;  // sfix15_En5
  wire signed [14:0] dataIn_1_cast_im;  // sfix15_En5
  reg signed [14:0] intdelay_reg [0:2];  // sfix15 [3]
  wire signed [14:0] intdelay_reg_next [0:2];  // sfix15_En5 [3]
  wire signed [14:0] din_1_1_re_dly;  // sfix15_En5
  reg signed [14:0] intdelay_reg_1 [0:2];  // sfix15 [3]
  wire signed [14:0] intdelay_reg_next_1 [0:2];  // sfix15_En5 [3]
  wire signed [14:0] din_1_1_im_dly;  // sfix15_En5
  reg  [0:2] intdelay_reg_2;  // ufix1 [3]
  wire [0:2] intdelay_reg_next_2;  // ufix1 [3]
  wire din_1_vld_dly;
  wire signed [14:0] twdl_1_1_re;  // sfix15_En13
  wire signed [14:0] twdl_1_1_im;  // sfix15_En13
  ...
  wire proc_1_enb;
  wire multiply_1_J;
  wire signed [14:0] dout_1_1_re;  // sfix15_En5
  wire signed [14:0] dout_1_1_im;  // sfix15_En5
  wire dout_1_1_vld;
  ...
  wire proc_2_enb;
  wire multiply_2_J;
  wire signed [14:0] dout_2_1_re;  // sfix15_En5
  wire signed [14:0] dout_2_1_im;  // sfix15_En5
  wire dout_2_1_vld;
  reg signed [14:0] intdelay_reg_4 [0:2];  // sfix15 [3]
  wire signed [14:0] intdelay_reg_next_4 [0:2];  // sfix15_En5 [3]
  wire signed [14:0] din_3_1_re_dly;  // sfix15_En5
  reg signed [14:0] intdelay_reg_5 [0:2];  // sfix15 [3]
  wire signed [14:0] intdelay_reg_next_5 [0:2];  // sfix15_En5 [3]
  wire signed [14:0] din_3_1_im_dly;  // sfix15_En5
  reg  [0:2] intdelay_reg_6;  // ufix1 [3]
  wire [0:2] intdelay_reg_next_6;  // ufix1 [3]
  wire din_3_vld_dly;
  wire signed [14:0] twdl_3_1_re;  // sfix15_En13
  wire signed [14:0] twdl_3_1_im;  // sfix15_En13
  wire twdl_3_1_vld;
  ...
  wire proc_3_enb;
  wire multiply_3_J;
  wire signed [14:0] dout_3_1_re;  // sfix15_En5
  wire signed [14:0] dout_3_1_im;  // sfix15_En5
  wire dout_3_1_vld;
  ...
  wire proc_4_enb;
  wire multiply_4_J;
  wire signed [14:0] dout_4_1_re;  // sfix15_En5
  wire signed [14:0] dout_4_1_im;  // sfix15_En5
  wire dout_4_1_vld;
  reg signed [14:0] intdelay_reg_7 [0:2];  // sfix15 [3]
  wire signed [14:0] intdelay_reg_next_7 [0:2];  // sfix15_En5 [3]
  wire signed [14:0] din_5_1_re_dly;  // sfix15_En5
  reg signed [14:0] intdelay_reg_8 [0:2];  // sfix15 [3]
  wire signed [14:0] intdelay_reg_next_8 [0:2];  // sfix15_En5 [3]
  wire signed [14:0] din_5_1_im_dly;  // sfix15_En5
  reg  [0:2] intdelay_reg_9;  // ufix1 [3]
  wire [0:2] intdelay_reg_next_9;  // ufix1 [3]
  wire din_5_vld_dly;
  wire signed [14:0] twdl_5_1_re;  // sfix15_En13
  wire signed [14:0] twdl_5_1_im;  // sfix15_En13
  wire twdl_5_1_vld;
  ...
  wire proc_5_enb;
  wire multiply_5_J;
  wire signed [14:0] dout_5_1_re;  // sfix15_En5
  wire signed [14:0] dout_5_1_im;  // sfix15_En5
  wire dout_5_1_vld;
  ...
  wire proc_6_enb;
  wire multiply_6_J;
  wire signed [14:0] dout_6_1_re;  // sfix15_En5
  wire signed [14:0] dout_6_1_im;  // sfix15_En5
  wire dout_6_1_vld;
  wire signed [14:0] dout_re1;  // sfix15_En5
  wire signed [14:0] dout_im1;  // sfix15_En5
  wire dout_vld1;
  ...
  assign dataIn_1_cast_re = dataIn;
  assign dataIn_1_cast_im = 15'sb000000000000000;
  ...
  always @(posedge clk)
    begin : intdelay_process
      if (reset_x == 1'b1) begin
        intdelay_reg[0] <= 15'sb000000000000000;
        intdelay_reg[1] <= 15'sb000000000000000;
        intdelay_reg[2] <= 15'sb000000000000000;
      end
      else begin
        if (enb) begin
  ...
  assign intdelay_reg_next[0] = dataIn_1_cast_re;
  ...
  always @(posedge clk)
    begin : intdelay_1_process
      if (reset_x == 1'b1) begin
        intdelay_reg_1[0] <= 15'sb000000000000000;
        intdelay_reg_1[1] <= 15'sb000000000000000;
        intdelay_reg_1[2] <= 15'sb000000000000000;
      end
      else begin
        if (enb) begin
          if (softReset == 1'b1) begin
  ...
  assign intdelay_reg_next_1[0] = dataIn_1_cast_im;
  ...
  assign twdl_1_1_re = 15'sb010000000000000;



  assign twdl_1_1_im = 15'sb000000000000000;
  ...
  RADIX22FFT_SDF1_1 u_SDF1_1_1 (.clk(clk),
                                .reset_x(reset_x),
                                .enb(enb),
                                .din_1_1_re_dly(din_1_1_re_dly),  // sfix15_En5
                                .din_1_1_im_dly(din_1_1_im_dly),  // sfix15_En5
                                .din_1_vld_dly(din_1_vld_dly),
                                .rd_1_Addr(rd_1_Addr),  // ufix5
                                .rd_1_Enb(rd_1_Enb),
                                .twdl_1_1_re(twdl_1_1_re),  // sfix15_En13
                                .twdl_1_1_im(twdl_1_1_im),  // sfix15_En13
  ...
  always @(posedge clk)
    begin : intdelay_4_process
      if (reset_x == 1'b1) begin
        intdelay_reg_4[0] <= 15'sb000000000000000;
        intdelay_reg_4[1] <= 15'sb000000000000000;
        intdelay_reg_4[2] <= 15'sb000000000000000;
      end
      else begin
        if (enb) begin
          if (softReset == 1'b1) begin
  ...
  always @(posedge clk)
    begin : intdelay_5_process
      if (reset_x == 1'b1) begin
        intdelay_reg_5[0] <= 15'sb000000000000000;
        intdelay_reg_5[1] <= 15'sb000000000000000;
        intdelay_reg_5[2] <= 15'sb000000000000000;
      end
      else begin
        if (enb) begin
          if (softReset == 1'b1) begin
  ...
  always @(posedge clk)
    begin : intdelay_7_process
      if (reset_x == 1'b1) begin
        intdelay_reg_7[0] <= 15'sb000000000000000;
        intdelay_reg_7[1] <= 15'sb000000000000000;
        intdelay_reg_7[2] <= 15'sb000000000000000;
      end
      else begin
        if (enb) begin
          if (softReset == 1'b1) begin
  ...
  always @(posedge clk)
    begin : intdelay_8_process
      if (reset_x == 1'b1) begin
        intdelay_reg_8[0] <= 15'sb000000000000000;
        intdelay_reg_8[1] <= 15'sb000000000000000;
        intdelay_reg_8[2] <= 15'sb000000000000000;
      end
      else begin
        if (enb) begin
          if (softReset == 1'b1) begin
  ...
  RADIX2FFT_bitNatural u_NaturalOrder_Stage (.clk(clk),
                                             ...
                                             .dout_6_1_vld(dout_6_1_vld),
                                             .softReset(softReset),
                                             .dout_re1(dout_re1),  // sfix15_En5
                                             .dout_im1(dout_im1),  // sfix15_En5
                                             .dout_vld1(dout_vld1)
                                             );
