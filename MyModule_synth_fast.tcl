...
report area > ../Reports/Top_synth_area_report_DFHT_slow
report timing > ../Reports/Top_synth_timing_report_DFHT_slow
## Write out synthesized Verilog netlist
write_hdl -mapped > ../Source/FDHT_synth_slow.v
## Write out the SDC file we will take into the place n route tool
write_sdc > ../Source/hilbert_out_slow.sdc
gui_show
