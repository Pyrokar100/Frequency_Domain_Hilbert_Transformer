...
// Source Path: FDHT_N/FDHT/DFT/RADIX22FFT_SDF2_2
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module RADIX22FFT_SDF2_2
  ...
  input   multiply_2_J;
  input   softReset;
  output  signed [14:0] dout_2_1_re;  // sfix15_En5
  output  signed [14:0] dout_2_1_im;  // sfix15_En5
  output  dout_2_1_vld;
  ...
  always @(Radix22ButterflyG2_procEnb_dly, Radix22ButterflyG2_procEnb_dly1,
       ...
       dout_1_1_re, dout_1_1_im, dinVld, dout_1_1_re, dout_1_1_im, btfin_vld,
       x_re_dly, x_im_dly, x_vld_dly, multiply_2_J) begin
  ...
  SDFCommutator2 u_SDFCOMMUTATOR_2 (.clk(clk),
                                    ...
                                    .wrAddr(wrAddr),  // ufix4
                                    .wrEnb(wrEnb),
                                    .dout_2_1_re(dout_2_1_re),  // sfix15_En5
                                    .dout_2_1_im(dout_2_1_im),  // sfix15_En5
