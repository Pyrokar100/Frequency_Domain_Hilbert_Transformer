// -------------------------------------------------------------
// 
// File Name: C:\Users\Carlos Cajas\Desktop\DSP\nuevo_chale\FDHT_N\RADIX2FFT_bitNatural_block.v
...
// Source Path: FDHT_N/FDHT/DFT-2/RADIX2FFT_bitNatural
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module RADIX2FFT_bitNatural_block
  ...
  input   reset_x;
  input   enb;
  input   signed [40:0] dout_6_1_re;  // sfix41_En28
  input   signed [40:0] dout_6_1_im;  // sfix41_En28
  input   dout_6_1_vld;
  input   softReset;
  output  signed [40:0] dout_re1;  // sfix41_En28
  output  signed [40:0] dout_im1;  // sfix41_En28
  output  dout_vld1;
  ...
  wire signed [40:0] memOut_im;  // sfix41_En28
  wire signed [40:0] memOut_re;  // sfix41_En28
  ...
  reg signed [40:0] rdStateMachineBitNatural_doutReReg;  // sfix41
  reg signed [40:0] rdStateMachineBitNatural_doutImReg;  // sfix41
  ...
  reg signed [40:0] rdStateMachineBitNatural_doutReReg_next;  // sfix41_En28
  reg signed [40:0] rdStateMachineBitNatural_doutImReg_next;  // sfix41_En28
  reg signed [40:0] dout_re1_1;  // sfix41_En28
  reg signed [40:0] dout_im1_1;  // sfix41_En28
  reg  dout_vld1_1;
  ...
  always @(posedge clk)
    begin : rdStateMachineBitNatural_process
      if (reset_x == 1'b1) begin
        ...
        rdStateMachineBitNatural_doutReReg <= 41'sh00000000000;
        rdStateMachineBitNatural_doutImReg <= 41'sh00000000000;
      end
      else begin
        if (enb) begin
