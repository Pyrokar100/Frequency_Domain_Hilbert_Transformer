...
// Source Path: FDHT_N/FDHT/DFT/RADIX22FFT_SDF2_6/SDFCommutator6
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module SDFCommutator6
  ...
  input   xf_vld;
  input   signed [14:0] dinf_re;  // sfix15_En5
  input   signed [14:0] dinf_im;  // sfix15_En5
  input   dinf_vld;
  ...
  reg signed [14:0] SDFCummutator_btf1_re_dly;  // sfix15
  reg signed [14:0] SDFCummutator_btf1_im_dly;  // sfix15
  ...
  reg signed [14:0] SDFCummutator_btf1_re_dly_next;  // sfix15_En5
  reg signed [14:0] SDFCummutator_btf1_im_dly_next;  // sfix15_En5
  ...
  reg signed [14:0] dout_6_1_re_1;  // sfix15_En5
  reg signed [14:0] dout_6_1_im_1;  // sfix15_En5
  reg  dout_6_1_vld_1;
  ...
  always @(posedge clk)
    begin : SDFCummutator_process
      if (reset_x == 1'b1) begin
        ...
        SDFCummutator_btf1_re_dly <= 15'sb000000000000000;
        SDFCummutator_btf1_im_dly <= 15'sb000000000000000;
  ...
  always @(SDFCummutator_out_re, SDFCummutator_out_im, SDFCummutator_out_vld,
       ...
       SDFCummutator_btf1_im_dly, SDFCummutator_btf1_vld_dly, dinf_re, dinf_im,
