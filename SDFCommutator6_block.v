...
// Source Path: FDHT_N/FDHT/DFT-2/RADIX22FFT_SDF2_6/SDFCommutator6
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module SDFCommutator6_block
  ...
  reg signed [40:0] SDFCummutator_btf1_re_dly;  // sfix41
  reg signed [40:0] SDFCummutator_btf1_im_dly;  // sfix41
  ...
  reg signed [40:0] SDFCummutator_btf1_re_dly_next;  // sfix41_En28
  reg signed [40:0] SDFCummutator_btf1_im_dly_next;  // sfix41_En28
  ...
  reg signed [40:0] dout_6_1_re_1;  // sfix41_En28
  reg signed [40:0] dout_6_1_im_1;  // sfix41_En28
  reg  dout_6_1_vld_1;
  ...
  always @(posedge clk)
    begin : SDFCummutator_process
      if (reset_x == 1'b1) begin
        ...
        SDFCummutator_btf1_re_dly <= 41'sh00000000000;
        SDFCummutator_btf1_im_dly <= 41'sh00000000000;
