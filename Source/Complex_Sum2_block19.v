...
// -------------------------------------------------------------
// 
// Module: Complex_Sum2_block19
// Source Path: newhope_cambios/FDHT/DFT_2/DFT10 - block_2/DFT5-row 2/DFT5-1/Complex-Sum2
// Hierarchy Level: 5
// 
// -------------------------------------------------------------
...
module Complex_Sum2_block19
  ...
  reg signed [36:0] delayMatch_reg [0:13];  // sfix37 [14]
  wire signed [36:0] delayMatch_reg_next [0:13];  // sfix37_En22 [14]
  wire signed [36:0] Complex_to_Real_Imag2_out1;  // sfix37_En22
  wire signed [36:0] Sum_out1;  // sfix37_En22
  reg signed [36:0] delayMatch1_reg [0:13];  // sfix37 [14]
  wire signed [36:0] delayMatch1_reg_next [0:13];  // sfix37_En22 [14]
  ...
  always @(posedge clk)
    begin : delayMatch_process
      if (reset_x == 1'b1) begin
        ...
        delayMatch_reg[13] <= 37'sh0000000000;
      end
      else begin
        if (enb) begin
  ...
  assign Complex_to_Real_Imag2_out1 = delayMatch_reg[13];
  ...
  always @(posedge clk)
    begin : delayMatch1_process
      if (reset_x == 1'b1) begin
        ...
        delayMatch1_reg[13] <= 37'sh0000000000;
      end
      else begin
        if (enb) begin
  ...
  assign Complex_to_Real_Imag2_out2 = delayMatch1_reg[13];
...
endmodule  // Complex_Sum2_block19
