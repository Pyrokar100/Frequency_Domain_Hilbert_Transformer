...
// -------------------------------------------------------------
// 
// Module: Complex_Sum_block13
// Source Path: newhope_cambios/FDHT/DFT/DFT10 - block/DFT5-row 1/DFT5-5/Complex-Sum
// Hierarchy Level: 5
// 
// -------------------------------------------------------------
...
module Complex_Sum_block13
  ...
  reg signed [36:0] delayMatch_reg [0:2];  // sfix37 [3]
  wire signed [36:0] delayMatch_reg_next [0:2];  // sfix37_En22 [3]
  ...
  assign Complex_to_Real_Imag1_out1_1 = delayMatch_reg[2];
  ...
  assign Complex_to_Real_Imag1_out2_1 = delayMatch1_reg[2];
