...
// -------------------------------------------------------------
// 
// Module: Complex_Sum_block31
// Source Path: newhope_cambios/FDHT/DFT_2/DFT10 - block_2/DFT2-column 4/DFT2-2/Complex-Sum
// Hierarchy Level: 5
// 
// -------------------------------------------------------------
...
module Complex_Sum_block31
  ...
  reg signed [36:0] delayMatch_reg [0:5];  // sfix37 [6]
  wire signed [36:0] delayMatch_reg_next [0:5];  // sfix37_En22 [6]
  wire signed [36:0] Complex_to_Real_Imag1_out1;  // sfix37_En22
  wire signed [36:0] Sum_out1;  // sfix37_En22
  reg signed [36:0] delayMatch1_reg [0:5];  // sfix37 [6]
  wire signed [36:0] delayMatch1_reg_next [0:5];  // sfix37_En22 [6]
  ...
  assign Complex_to_Real_Imag1_out1 = delayMatch_reg[5];
  ...
  assign Complex_to_Real_Imag1_out2 = delayMatch1_reg[5];
