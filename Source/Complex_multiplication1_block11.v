...
// -------------------------------------------------------------
// 
// Module: Complex_multiplication1_block11
// Source Path: newhope_cambios/FDHT/DFT/W50/Complex-multiplication1
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module Complex_multiplication1_block11
  ...
  reg signed [36:0] reduced_reg [0:5];  // sfix37 [6]
  wire signed [36:0] reduced_reg_next [0:5];  // sfix37_En22 [6]
  ...
  reg signed [36:0] HwModeRegister3_reg [0:5];  // sfix37 [6]
  wire signed [36:0] HwModeRegister3_reg_next [0:5];  // sfix37_En22 [6]
  ...
  reg signed [36:0] HwModeRegister5_reg [0:5];  // sfix37 [6]
  wire signed [36:0] HwModeRegister5_reg_next [0:5];  // sfix37_En22 [6]
  ...
  assign In2_real_1 = reduced_reg[5];
  ...
  assign Product4_out1_1 = HwModeRegister3_reg[5];
  ...
  assign in2_imag_1 = HwModeRegister5_reg[5];
...
endmodule  // Complex_multiplication1_block11
