...
// -------------------------------------------------------------
// 
// Module: Complex_multiplication1_block14
// Source Path: newhope_cambios/FDHT/DFT_2/DFT10 - block_2/DFT5-row 1/DFT5-4/Complex-multiplication1
// Hierarchy Level: 5
// 
// -------------------------------------------------------------
...
module Complex_multiplication1_block14
  ...
  reg signed [36:0] reduced_reg [0:12];  // sfix37 [13]
  wire signed [36:0] reduced_reg_next [0:12];  // sfix37_En22 [13]
  ...
  reg signed [36:0] HwModeRegister3_reg [0:11];  // sfix37 [12]
  wire signed [36:0] HwModeRegister3_reg_next [0:11];  // sfix37_En22 [12]
  ...
  reg signed [36:0] HwModeRegister5_reg [0:11];  // sfix37 [12]
  wire signed [36:0] HwModeRegister5_reg_next [0:11];  // sfix37_En22 [12]
  ...
  assign In2_real_1 = reduced_reg[12];
  ...
  assign Product4_out1_1 = HwModeRegister3_reg[11];
  ...
  assign In2_imag_1 = HwModeRegister5_reg[11];
...
endmodule  // Complex_multiplication1_block14
