...
// -------------------------------------------------------------
// 
// Module: Complex_multiplication1_block20
// Source Path: newhope_cambios/FDHT/DFT_2/DFT10 - block_2/W10/Complex-multiplication1
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module Complex_multiplication1_block20
  ...
  reg signed [36:0] reduced_reg [0:15];  // sfix37 [16]
  wire signed [36:0] reduced_reg_next [0:15];  // sfix37_En22 [16]
  ...
  reg signed [36:0] HwModeRegister3_reg [0:15];  // sfix37 [16]
  wire signed [36:0] HwModeRegister3_reg_next [0:15];  // sfix37_En22 [16]
  ...
  reg signed [36:0] HwModeRegister5_reg [0:15];  // sfix37 [16]
  wire signed [36:0] HwModeRegister5_reg_next [0:15];  // sfix37_En22 [16]
  ...
  assign In2_real_1 = reduced_reg[15];
  ...
  assign Product4_out1_1 = HwModeRegister3_reg[15];
  ...
  assign In2_imag_1 = HwModeRegister5_reg[15];
...
endmodule  // Complex_multiplication1_block20
