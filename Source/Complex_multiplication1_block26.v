...
// -------------------------------------------------------------
// 
// Module: Complex_multiplication1_block26
// Source Path: newhope_cambios/FDHT/DFT_2/DFT5-block_IDFT/DFT5-column 2/DFT5-3/Complex-multiplication1
// Hierarchy Level: 5
// 
// -------------------------------------------------------------
...
module Complex_multiplication1_block26
  ...
  reg signed [36:0] reduced_reg [0:22];  // sfix37 [23]
  wire signed [36:0] reduced_reg_next [0:22];  // sfix37_En22 [23]
  ...
  reg signed [36:0] HwModeRegister3_reg [0:22];  // sfix37 [23]
  wire signed [36:0] HwModeRegister3_reg_next [0:22];  // sfix37_En22 [23]
  ...
  reg signed [36:0] HwModeRegister5_reg [0:22];  // sfix37 [23]
  wire signed [36:0] HwModeRegister5_reg_next [0:22];  // sfix37_En22 [23]
  ...
  always @(posedge clk)
    begin : reduced_1_process
      if (reset_x == 1'b1) begin
        ...
        reduced_reg[20] <= 37'sh0000000000;
        reduced_reg[21] <= 37'sh0000000000;
        reduced_reg[22] <= 37'sh0000000000;
      end
      else begin
        if (enb) begin
  ...
  assign In2_real_1 = reduced_reg[22];
  ...
  always @(posedge clk)
    begin : HwModeRegister3_process
      if (reset_x == 1'b1) begin
        ...
        HwModeRegister3_reg[20] <= 37'sh0000000000;
        HwModeRegister3_reg[21] <= 37'sh0000000000;
        HwModeRegister3_reg[22] <= 37'sh0000000000;
      end
      else begin
        if (enb) begin
          ...
          HwModeRegister3_reg[20] <= HwModeRegister3_reg_next[20];
          HwModeRegister3_reg[21] <= HwModeRegister3_reg_next[21];
          HwModeRegister3_reg[22] <= HwModeRegister3_reg_next[22];
        end
      end
    end

  assign Product4_out1_1 = HwModeRegister3_reg[22];
  ...
  assign HwModeRegister3_reg_next[20] = HwModeRegister3_reg[19];
  assign HwModeRegister3_reg_next[21] = HwModeRegister3_reg[20];
  assign HwModeRegister3_reg_next[22] = HwModeRegister3_reg[21];
  ...
  always @(posedge clk)
    begin : HwModeRegister5_process
      if (reset_x == 1'b1) begin
        ...
        HwModeRegister5_reg[20] <= 37'sh0000000000;
        HwModeRegister5_reg[21] <= 37'sh0000000000;
        HwModeRegister5_reg[22] <= 37'sh0000000000;
      end
      else begin
        if (enb) begin
          ...
          HwModeRegister5_reg[20] <= HwModeRegister5_reg_next[20];
          HwModeRegister5_reg[21] <= HwModeRegister5_reg_next[21];
          HwModeRegister5_reg[22] <= HwModeRegister5_reg_next[22];
        end
      end
    end

  assign In2_imag_1 = HwModeRegister5_reg[22];
  ...
  assign HwModeRegister5_reg_next[20] = HwModeRegister5_reg[19];
  assign HwModeRegister5_reg_next[21] = HwModeRegister5_reg[20];
  assign HwModeRegister5_reg_next[22] = HwModeRegister5_reg[21];
...
endmodule  // Complex_multiplication1_block26
