...
// -------------------------------------------------------------
// 
// Module: Complex_multiplication1_block7
// Source Path: newhope_cambios/FDHT/DFT/DFT10 - block/W10/Complex-multiplication1
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module Complex_multiplication1_block7
  ...
  reg signed [36:0] reduced_reg [0:3];  // sfix37 [4]
  wire signed [36:0] reduced_reg_next [0:3];  // sfix37_En22 [4]
  ...
  reg signed [36:0] HwModeRegister3_reg [0:3];  // sfix37 [4]
  wire signed [36:0] HwModeRegister3_reg_next [0:3];  // sfix37_En22 [4]
  ...
  reg signed [36:0] HwModeRegister5_reg [0:3];  // sfix37 [4]
  wire signed [36:0] HwModeRegister5_reg_next [0:3];  // sfix37_En22 [4]
  ...
  assign In2_real_1 = reduced_reg[3];
  ...
  assign Product4_out1_1 = HwModeRegister3_reg[3];
  ...
  assign In2_imag_1 = HwModeRegister5_reg[3];
...
endmodule  // Complex_multiplication1_block7
