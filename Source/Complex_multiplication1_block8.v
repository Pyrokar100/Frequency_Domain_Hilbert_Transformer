...
// -------------------------------------------------------------
// 
// Module: Complex_multiplication1_block8
// Source Path: newhope_cambios/FDHT/DFT/DFT5/DFT5-column 1/DFT5-2/Complex-multiplication1
// Hierarchy Level: 5
// 
// -------------------------------------------------------------
...
module Complex_multiplication1_block8
  ...
  reg signed [36:0] reduced_reg [0:7];  // sfix37 [8]
  wire signed [36:0] reduced_reg_next [0:7];  // sfix37_En22 [8]
  ...
  reg signed [36:0] HwModeRegister3_reg [0:7];  // sfix37 [8]
  wire signed [36:0] HwModeRegister3_reg_next [0:7];  // sfix37_En22 [8]
  ...
  reg signed [36:0] HwModeRegister5_reg [0:7];  // sfix37 [8]
  wire signed [36:0] HwModeRegister5_reg_next [0:7];  // sfix37_En22 [8]
  ...
  assign In2_real_1 = reduced_reg[7];
  ...
  assign Product4_out1_1 = HwModeRegister3_reg[7];
  ...
  assign In2_imag_1 = HwModeRegister5_reg[7];
...
endmodule  // Complex_multiplication1_block8
