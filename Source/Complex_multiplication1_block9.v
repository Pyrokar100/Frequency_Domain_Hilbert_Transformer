...
// -------------------------------------------------------------
// 
// Module: Complex_multiplication1_block9
// Source Path: newhope_cambios/FDHT/DFT/DFT5/DFT5-column 1/DFT5-3/Complex-multiplication1
// Hierarchy Level: 5
// 
// -------------------------------------------------------------
...
module Complex_multiplication1_block9
  ...
  reg signed [36:0] HwModeRegister3_reg [0:8];  // sfix37 [9]
  wire signed [36:0] HwModeRegister3_reg_next [0:8];  // sfix37_En22 [9]
  ...
  reg signed [36:0] HwModeRegister5_reg [0:8];  // sfix37 [9]
  wire signed [36:0] HwModeRegister5_reg_next [0:8];  // sfix37_En22 [9]
  ...
  assign Product4_out1_1 = HwModeRegister3_reg[8];
  ...
  assign In2_imag_1 = HwModeRegister5_reg[8];
...
endmodule  // Complex_multiplication1_block9
