...
// -------------------------------------------------------------
// 
// Module: Complex_multiplication2_block23
// Source Path: newhope_cambios/FDHT/DFT_2/DFT5-block_IDFT/DFT5-column 1/DFT5-4/Complex-multiplication2
// Hierarchy Level: 5
// 
// -------------------------------------------------------------
...
module Complex_multiplication2_block23
  ...
  reg signed [36:0] reduced_reg [0:20];  // sfix37 [21]
  wire signed [36:0] reduced_reg_next [0:20];  // sfix37_En22 [21]
  ...
  reg signed [36:0] HwModeRegister3_reg [0:20];  // sfix37 [21]
  wire signed [36:0] HwModeRegister3_reg_next [0:20];  // sfix37_En22 [21]
  ...
  reg signed [36:0] HwModeRegister5_reg [0:20];  // sfix37 [21]
  wire signed [36:0] HwModeRegister5_reg_next [0:20];  // sfix37_En22 [21]
  ...
  assign In2_real_1 = reduced_reg[20];
  ...
  assign Product4_out1_1 = HwModeRegister3_reg[20];
  ...
  assign In2_imag_1 = HwModeRegister5_reg[20];
...
endmodule  // Complex_multiplication2_block23
