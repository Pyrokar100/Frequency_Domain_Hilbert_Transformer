...
// -------------------------------------------------------------
// 
// Module: Complex_multiplication2_block9
// Source Path: newhope_cambios/FDHT/DFT/DFT5/DFT5-column 1/DFT5-3/Complex-multiplication2
// Hierarchy Level: 5
// 
// -------------------------------------------------------------
...
module Complex_multiplication2_block9
  ...
  reg signed [36:0] reduced_reg [0:8];  // sfix37 [9]
  wire signed [36:0] reduced_reg_next [0:8];  // sfix37_En22 [9]
  ...
  assign In2_real_1 = reduced_reg[8];
...
endmodule  // Complex_multiplication2_block9
