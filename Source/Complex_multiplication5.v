...
// -------------------------------------------------------------
// 
// Module: Complex_multiplication5
// Source Path: newhope_cambios/FDHT/DFT/W50/Complex-multiplication5
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module Complex_multiplication5
  ...
  reg signed [36:0] reduced_reg [0:2];  // sfix37 [3]
  wire signed [36:0] reduced_reg_next [0:2];  // sfix37_En22 [3]
  ...
  reg signed [36:0] HwModeRegister3_reg [0:2];  // sfix37 [3]
  wire signed [36:0] HwModeRegister3_reg_next [0:2];  // sfix37_En22 [3]
  ...
  reg signed [36:0] HwModeRegister5_reg [0:2];  // sfix37 [3]
  wire signed [36:0] HwModeRegister5_reg_next [0:2];  // sfix37_En22 [3]
  ...
  assign In2_real_1 = reduced_reg[2];
  ...
  assign Product4_out1_1 = HwModeRegister3_reg[2];
  ...
  assign in2_imag_1 = HwModeRegister5_reg[2];
...
endmodule  // Complex_multiplication5
