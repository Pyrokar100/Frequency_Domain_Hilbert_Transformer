...
// -------------------------------------------------------------
// 
// Module: Complex_multiplication_block15
// Source Path: newhope_cambios/FDHT/DFT/DFT5/DFT5-column 2/DFT5-2/Complex-multiplication
// Hierarchy Level: 5
// 
// -------------------------------------------------------------
...
module Complex_multiplication_block15
  ...
  reg signed [36:0] reduced_reg [0:10];  // sfix37 [11]
  wire signed [36:0] reduced_reg_next [0:10];  // sfix37_En22 [11]
  ...
  reg signed [36:0] HwModeRegister3_reg [0:9];  // sfix37 [10]
  wire signed [36:0] HwModeRegister3_reg_next [0:9];  // sfix37_En22 [10]
  ...
  reg signed [36:0] HwModeRegister5_reg [0:9];  // sfix37 [10]
  wire signed [36:0] HwModeRegister5_reg_next [0:9];  // sfix37_En22 [10]
  ...
  assign In2_real_1 = reduced_reg[10];
  ...
  assign Product4_out1_1 = HwModeRegister3_reg[9];
  ...
  assign In2_imag_1 = HwModeRegister5_reg[9];
...
endmodule  // Complex_multiplication_block15
