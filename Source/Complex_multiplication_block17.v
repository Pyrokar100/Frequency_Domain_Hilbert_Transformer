...
// -------------------------------------------------------------
// 
// Module: Complex_multiplication_block17
// Source Path: newhope_cambios/FDHT/DFT_2/DFT10 - block_2/DFT2-column 1/DFT2-2/Complex-multiplication
// Hierarchy Level: 5
// 
// -------------------------------------------------------------
...
module Complex_multiplication_block17
  ...
  reg signed [1:0] reduced_reg [0:13];  // sfix2 [14]
  wire signed [1:0] reduced_reg_next [0:13];  // sfix2 [14]
  ...
  reg signed [36:0] HwModeRegister1_reg [0:14];  // sfix37 [15]
  wire signed [36:0] HwModeRegister1_reg_next [0:14];  // sfix37_En22 [15]
  ...
  reg signed [1:0] delayMatch3_reg [0:13];  // sfix2 [14]
  wire signed [1:0] delayMatch3_reg_next [0:13];  // sfix2 [14]
  ...
  assign Complex_to_Real_Imag2_out1_1 = reduced_reg[13];
  ...
  assign Product4_out1_1 = HwModeRegister1_reg[14];
  ...
  assign Complex_to_Real_Imag2_out2_1 = delayMatch3_reg[13];
...
endmodule  // Complex_multiplication_block17
