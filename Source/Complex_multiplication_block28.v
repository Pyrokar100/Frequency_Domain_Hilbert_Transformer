...
// -------------------------------------------------------------
// 
// Module: Complex_multiplication_block28
// Source Path: newhope_cambios/FDHT/DFT_2/DFT10 - block_2/DFT5-row 2/DFT5-4/Complex-multiplication
// Hierarchy Level: 5
// 
// -------------------------------------------------------------
...
module Complex_multiplication_block28
  ...
  reg signed [36:0] reduced_reg [0:13];  // sfix37 [14]
  wire signed [36:0] reduced_reg_next [0:13];  // sfix37_En22 [14]
  ...
  reg signed [36:0] HwModeRegister3_reg [0:14];  // sfix37 [15]
  wire signed [36:0] HwModeRegister3_reg_next [0:14];  // sfix37_En22 [15]
  ...
  reg signed [36:0] HwModeRegister5_reg [0:14];  // sfix37 [15]
  wire signed [36:0] HwModeRegister5_reg_next [0:14];  // sfix37_En22 [15]
  ...
  assign In2_real_1 = reduced_reg[13];
  ...
  assign Product4_out1_1 = HwModeRegister3_reg[14];
  ...
  assign In2_imag_1 = HwModeRegister5_reg[14];
...
endmodule  // Complex_multiplication_block28
