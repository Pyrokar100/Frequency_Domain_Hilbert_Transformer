...
// 
// Module: DFT2_2
// Source Path: newhope_cambios/FDHT/DFT/DFT10 - block/DFT2-column 1/DFT2-2
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module DFT2_2
  ...
  Complex_multiplication u_Complex_multiplication (.clk(clk),
                                                   .reset_x(reset_x),
                                                   .enb(enb),
  ...
  Complex_Sum_block u_Complex_Sum (.clk(clk),
                                   .reset_x(reset_x),
                                   .enb(enb),
