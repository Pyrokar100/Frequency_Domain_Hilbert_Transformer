...
// -------------------------------------------------------------
// 
// Module: DFT2_2_block7
// Source Path: newhope_cambios/FDHT/DFT_2/DFT10 - block_2/DFT2-column 4/DFT2-2
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module DFT2_2_block7
  ...
  Complex_multiplication_block20 u_Complex_multiplication (.clk(clk),
                                                           .reset_x(reset_x),
                                                           .enb(enb),
  ...
  Complex_Sum_block31 u_Complex_Sum (.clk(clk),
                                     .reset_x(reset_x),
                                     .enb(enb),
