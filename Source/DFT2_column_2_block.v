...
// -------------------------------------------------------------
// 
// Module: DFT2_column_2_block
// Source Path: newhope_cambios/FDHT/DFT_2/DFT10 - block_2/DFT2-column 2
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module DFT2_column_2_block
  ...
  DFT2_1_block5 u_DFT2_1 (.clk(clk),
                          .reset_x(reset_x),
                          .enb(enb),
  ...
  DFT2_2_block5 u_DFT2_2 (.clk(clk),
                          .reset_x(reset_x),
                          .enb(enb),
                          .in1_re(in1_re),  // sfix37_En22
                          .in1_im(in1_im),  // sfix37_En22
