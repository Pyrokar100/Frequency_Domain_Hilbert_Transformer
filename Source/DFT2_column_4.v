...
// -------------------------------------------------------------
// 
// Module: DFT2_column_4
// Source Path: newhope_cambios/FDHT/DFT/DFT10 - block/DFT2-column 4
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module DFT2_column_4
  ...
  DFT2_1_block2 u_DFT2_1 (.clk(clk),
                          .reset_x(reset_x),
                          .enb(enb),
  ...
  DFT2_2_block2 u_DFT2_2 (.clk(clk),
                          .reset_x(reset_x),
                          .enb(enb),
                          .in1_re(in1_re),  // sfix37_En22
                          .in1_im(in1_im),  // sfix37_En22
