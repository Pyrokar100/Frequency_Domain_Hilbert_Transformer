...
// -------------------------------------------------------------
// 
// Module: DFT5_1_block3
// Source Path: newhope_cambios/FDHT/DFT_2/DFT10 - block_2/DFT5-row 1/DFT5-1
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module DFT5_1_block3
  ...
  Complex_Sum_block34 u_Complex_Sum (.clk(clk),
                                     .reset_x(reset_x),
                                     .enb(enb),
  ...
  Complex_Sum1_block14 u_Complex_Sum1 (.clk(clk),
                                       .reset_x(reset_x),
                                       .enb(enb),
  ...
  Complex_Sum3_block14 u_Complex_Sum3 (.clk(clk),
                                       .reset_x(reset_x),
                                       .enb(enb),
                                       .In1_re(Complex_Sum1_out1_re),  // sfix37_En22
  ...
  Complex_Sum2_block14 u_Complex_Sum2 (.In1_re(Complex_Sum_out1_re),  // sfix37_En22
