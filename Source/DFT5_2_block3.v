...
// -------------------------------------------------------------
// 
// Module: DFT5_2_block3
// Source Path: newhope_cambios/FDHT/DFT_2/DFT10 - block_2/DFT5-row 1/DFT5-2
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module DFT5_2_block3
  ...
  Complex_multiplication_block22 u_Complex_multiplication (.clk(clk),
                                                           .reset_x(reset_x),
                                                           .enb(enb),
  ...
  Complex_Sum_block35 u_Complex_Sum (.clk(clk),
                                     .reset_x(reset_x),
                                     .enb(enb),
  ...
  Complex_multiplication1_block12 u_Complex_multiplication1 (.clk(clk),
                                                             .reset_x(reset_x),
                                                             .enb(enb),
  ...
  Complex_multiplication2_block12 u_Complex_multiplication2 (.clk(clk),
                                                             .reset_x(reset_x),
                                                             .enb(enb),
                                                             .In1_re(in4_re),  // ufix1
                                                             .In1_im(in4_im),  // ufix1
  ...
  Complex_Sum2_block15 u_Complex_Sum2 (.clk(clk),
                                       .reset_x(reset_x),
                                       .enb(enb),
  ...
  Complex_multiplication3_block12 u_Complex_multiplication3 (.clk(clk),
                                                             .reset_x(reset_x),
                                                             .enb(enb),
                                                             .In1_re(in5_re),  // ufix1
                                                             .In1_im(in5_im),  // ufix1
  ...
  Complex_Sum3_block15 u_Complex_Sum3 (.clk(clk),
                                       .reset_x(reset_x),
                                       .enb(enb),
  ...
  Complex_Sum1_block15 u_Complex_Sum1 (.In1_re(Complex_Sum_out1_re),  // sfix37_En22
