...
// -------------------------------------------------------------
// 
// Module: DFT5_2_block6
// Source Path: newhope_cambios/FDHT/DFT_2/DFT5-block_IDFT/DFT5-column 2/DFT5-2
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module DFT5_2_block6
  ...
  Complex_multiplication_block35 u_Complex_multiplication (.clk(clk),
                                                           .reset_x(reset_x),
                                                           .enb(enb),
  ...
  Complex_Sum_block50 u_Complex_Sum (.clk(clk),
                                     .reset_x(reset_x),
                                     .enb(enb),
  ...
  Complex_multiplication1_block25 u_Complex_multiplication1 (.clk(clk),
                                                             .reset_x(reset_x),
                                                             .enb(enb),
  ...
  Complex_multiplication2_block25 u_Complex_multiplication2 (.clk(clk),
                                                             .reset_x(reset_x),
                                                             .enb(enb),
  ...
  Complex_Sum2_block30 u_Complex_Sum2 (.In1_re(Complex_multiplication1_out1_re),  // sfix37_En22
  ...
  Complex_multiplication3_block25 u_Complex_multiplication3 (.clk(clk),
                                                             .reset_x(reset_x),
                                                             .enb(enb),
  ...
  Complex_Sum3_block30 u_Complex_Sum3 (.In1_re(Complex_Sum2_out1_re),  // sfix37_En22
  ...
  Complex_Sum1_block30 u_Complex_Sum1 (.In1_re(Complex_Sum_out1_re),  // sfix37_En22
