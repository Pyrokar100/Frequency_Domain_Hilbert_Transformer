...
// -------------------------------------------------------------
// 
// Module: DFT5_3_block1
// Source Path: newhope_cambios/FDHT/DFT/DFT5/DFT5-column 1/DFT5-3
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module DFT5_3_block1
  ...
  Complex_multiplication_block14 u_Complex_multiplication (.clk(clk),
                                                           .reset_x(reset_x),
                                                           .enb(enb),
  ...
  Complex_Sum_block21 u_Complex_Sum (.clk(clk),
                                     .reset_x(reset_x),
                                     .enb(enb),
  ...
  Complex_multiplication1_block9 u_Complex_multiplication1 (.clk(clk),
                                                            .reset_x(reset_x),
                                                            .enb(enb),
  ...
  Complex_multiplication2_block9 u_Complex_multiplication2 (.clk(clk),
                                                            .reset_x(reset_x),
                                                            .enb(enb),
  ...
  Complex_Sum2_block11 u_Complex_Sum2 (.In1_re(Complex_multiplication1_out1_re),  // sfix37_En22
  ...
  Complex_multiplication3_block9 u_Complex_multiplication3 (.clk(clk),
                                                            .reset_x(reset_x),
                                                            .enb(enb),
  ...
  Complex_Sum3_block11 u_Complex_Sum3 (.In1_re(Complex_Sum2_out1_re),  // sfix37_En22
  ...
  Complex_Sum1_block11 u_Complex_Sum1 (.In1_re(Complex_Sum_out1_re),  // sfix37_En22
