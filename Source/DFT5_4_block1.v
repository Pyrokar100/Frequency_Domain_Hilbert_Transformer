...
// -------------------------------------------------------------
// 
// Module: DFT5_4_block1
// Source Path: newhope_cambios/FDHT/DFT_2/DFT10 - block_2/DFT5-row 1/DFT5-4
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module DFT5_4_block1
  ...
  Complex_multiplication_block24 u_Complex_multiplication (.clk(clk),
                                                           .reset_x(reset_x),
                                                           .enb(enb),
  ...
  Complex_Sum_block37 u_Complex_Sum (.clk(clk),
                                     .reset_x(reset_x),
                                     .enb(enb),
  ...
  Complex_multiplication1_block14 u_Complex_multiplication1 (.clk(clk),
                                                             .reset_x(reset_x),
                                                             .enb(enb),
  ...
  Complex_multiplication2_block14 u_Complex_multiplication2 (.clk(clk),
                                                             .reset_x(reset_x),
                                                             .enb(enb),
                                                             .In1_re(in4_re),  // ufix1
                                                             .In1_im(in4_im),  // ufix1
  ...
  Complex_Sum2_block17 u_Complex_Sum2 (.clk(clk),
                                       .reset_x(reset_x),
                                       .enb(enb),
  ...
  Complex_multiplication3_block14 u_Complex_multiplication3 (.clk(clk),
                                                             .reset_x(reset_x),
                                                             .enb(enb),
                                                             .In1_re(in5_re),  // ufix1
                                                             .In1_im(in5_im),  // ufix1
  ...
  Complex_Sum3_block17 u_Complex_Sum3 (.clk(clk),
                                       .reset_x(reset_x),
                                       .enb(enb),
  ...
  Complex_Sum1_block17 u_Complex_Sum1 (.In1_re(Complex_Sum_out1_re),  // sfix37_En22
