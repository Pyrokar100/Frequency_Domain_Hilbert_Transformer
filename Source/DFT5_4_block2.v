...
// -------------------------------------------------------------
// 
// Module: DFT5_4_block2
// Source Path: newhope_cambios/FDHT/DFT_2/DFT10 - block_2/DFT5-row 2/DFT5-4
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module DFT5_4_block2
  ...
  Complex_multiplication_block28 u_Complex_multiplication (.clk(clk),
                                                           .reset_x(reset_x),
                                                           .enb(enb),
  ...
  Complex_Sum_block42 u_Complex_Sum (.clk(clk),
                                     .reset_x(reset_x),
                                     .enb(enb),
  ...
  assign Product1_mul_temp = Constant1_out1 * alpha0_951056;
  ...
  Complex_multiplication1_block18 u_Complex_multiplication1 (.clk(clk),
                                                             .reset_x(reset_x),
                                                             .enb(enb),
                                                             .In1_re(in3_re),  // ufix1
                                                             .In1_im(in3_im),  // ufix1
  ...
  Complex_multiplication2_block18 u_Complex_multiplication2 (.clk(clk),
                                                             .reset_x(reset_x),
                                                             .enb(enb),
                                                             .In1_re(in4_re),  // ufix1
                                                             .In1_im(in4_im),  // ufix1
  ...
  Complex_Sum2_block22 u_Complex_Sum2 (.clk(clk),
                                       .reset_x(reset_x),
                                       .enb(enb),
  ...
  assign Product2_mul_temp = alpha0_587785 * Constant1_out1;
  ...
  Complex_multiplication3_block18 u_Complex_multiplication3 (.clk(clk),
                                                             .reset_x(reset_x),
                                                             .enb(enb),
                                                             .In1_re(in5_re),  // ufix1
                                                             .In1_im(in5_im),  // ufix1
  ...
  Complex_Sum3_block22 u_Complex_Sum3 (.In1_re(Complex_Sum2_out1_re),  // sfix37_En22
  ...
  Complex_Sum1_block22 u_Complex_Sum1 (.clk(clk),
                                       .reset_x(reset_x),
                                       .enb(enb),
  ...
  assign out4_re = Complex_Sum1_out1_re;

  assign out4_im = Complex_Sum1_out1_im;

endmodule  // DFT5_4_block2
