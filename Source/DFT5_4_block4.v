...
// -------------------------------------------------------------
// 
// Module: DFT5_4_block4
// Source Path: newhope_cambios/FDHT/DFT_2/DFT5-block_IDFT/DFT5-column 2/DFT5-4
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module DFT5_4_block4
  ...
  Complex_multiplication_block37 u_Complex_multiplication (.clk(clk),
                                                           .reset_x(reset_x),
                                                           .enb(enb),
  ...
  Complex_Sum_block52 u_Complex_Sum (.clk(clk),
                                     .reset_x(reset_x),
                                     .enb(enb),
  ...
  Complex_multiplication1_block27 u_Complex_multiplication1 (.clk(clk),
                                                             .reset_x(reset_x),
                                                             .enb(enb),
  ...
  Complex_multiplication2_block27 u_Complex_multiplication2 (.clk(clk),
                                                             .reset_x(reset_x),
                                                             .enb(enb),
  ...
  Complex_Sum2_block32 u_Complex_Sum2 (.In1_re(Complex_multiplication1_out1_re),  // sfix37_En22
  ...
  Complex_multiplication3_block27 u_Complex_multiplication3 (.clk(clk),
                                                             .reset_x(reset_x),
                                                             .enb(enb),
  ...
  Complex_Sum3_block32 u_Complex_Sum3 (.In1_re(Complex_Sum2_out1_re),  // sfix37_En22
  ...
  Complex_Sum1_block32 u_Complex_Sum1 (.In1_re(Complex_Sum_out1_re),  // sfix37_En22
