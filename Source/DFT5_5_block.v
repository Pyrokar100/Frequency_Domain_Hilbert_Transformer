...
// 
// Module: DFT5_5_block
// Source Path: newhope_cambios/FDHT/DFT/DFT10 - block/DFT5-row 2/DFT5-5
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module DFT5_5_block
  ...
  Complex_multiplication_block11 u_Complex_multiplication (.clk(clk),
                                                           .reset_x(reset_x),
                                                           .enb(enb),
                                                           .In1(in2),  // sfix37_En22
  ...
  Complex_Sum_block18 u_Complex_Sum (.clk(clk),
                                     .reset_x(reset_x),
                                     .enb(enb),
                                     .In1(in1),  // sfix37_En22
  ...
  Complex_multiplication1_block6 u_Complex_multiplication1 (.clk(clk),
                                                            .reset_x(reset_x),
                                                            .enb(enb),
                                                            .In1(in3),  // sfix37_En22
  ...
  Complex_multiplication2_block6 u_Complex_multiplication2 (.clk(clk),
                                                            .reset_x(reset_x),
                                                            .enb(enb),
                                                            .In1(in4),  // sfix37_En22
                                                            .In2_real(Product4_out1_1),  // sfix37_En22
  ...
  Complex_Sum2_block8 u_Complex_Sum2 (.clk(clk),
                                      .reset_x(reset_x),
                                      .enb(enb),
  ...
  Complex_multiplication3_block6 u_Complex_multiplication3 (.clk(clk),
                                                            .reset_x(reset_x),
                                                            .enb(enb),
                                                            .In1(in5),  // sfix37_En22
                                                            .In2_real(alpha0_309017),  // sfix37_En22
  ...
  Complex_Sum3_block8 u_Complex_Sum3 (.In1_re(Complex_Sum2_out1_re),  // sfix37_En22
  ...
  Complex_Sum1_block8 u_Complex_Sum1 (.clk(clk),
                                      .reset_x(reset_x),
                                      .enb(enb),
