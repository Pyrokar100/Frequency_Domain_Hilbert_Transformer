...
// -------------------------------------------------------------
// 
// Module: DFT5_5_block2
// Source Path: newhope_cambios/FDHT/DFT_2/DFT10 - block_2/DFT5-row 2/DFT5-5
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module DFT5_5_block2
  ...
  Complex_multiplication_block29 u_Complex_multiplication (.clk(clk),
                                                           .reset_x(reset_x),
                                                           .enb(enb),
  ...
  Complex_Sum_block43 u_Complex_Sum (.clk(clk),
                                     .reset_x(reset_x),
                                     .enb(enb),
  ...
  Complex_multiplication1_block19 u_Complex_multiplication1 (.clk(clk),
                                                             .reset_x(reset_x),
                                                             .enb(enb),
                                                             .In1_re(in3_re),  // ufix1
                                                             .In1_im(in3_im),  // ufix1
  ...
  Complex_multiplication2_block19 u_Complex_multiplication2 (.clk(clk),
                                                             .reset_x(reset_x),
                                                             .enb(enb),
                                                             .In1_re(in4_re),  // ufix1
                                                             .In1_im(in4_im),  // ufix1
  ...
  Complex_Sum2_block23 u_Complex_Sum2 (.clk(clk),
                                       .reset_x(reset_x),
                                       .enb(enb),
  ...
  Complex_multiplication3_block19 u_Complex_multiplication3 (.clk(clk),
                                                             .reset_x(reset_x),
                                                             .enb(enb),
                                                             .In1_re(in5_re),  // ufix1
                                                             .In1_im(in5_im),  // ufix1
  ...
  Complex_Sum3_block23 u_Complex_Sum3 (.In1_re(Complex_Sum2_out1_re),  // sfix37_En22
  ...
  Complex_Sum1_block23 u_Complex_Sum1 (.clk(clk),
                                       .reset_x(reset_x),
                                       .enb(enb),
