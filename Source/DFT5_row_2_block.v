...
// -------------------------------------------------------------
// 
// Module: DFT5_row_2_block
// Source Path: newhope_cambios/FDHT/DFT_2/DFT10 - block_2/DFT5-row 2
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module DFT5_row_2_block
  ...
  DFT5_1_block4 u_DFT5_1 (.clk(clk),
                          .reset_x(reset_x),
                          .enb(enb),
  ...
  DFT5_2_block4 u_DFT5_2 (.clk(clk),
                          .reset_x(reset_x),
                          .enb(enb),
                          .in1_re(in1_re),  // sfix37_En22
                          .in1_im(in1_im),  // sfix37_En22
  ...
  DFT5_3_block3 u_DFT5_3 (.clk(clk),
                          .reset_x(reset_x),
                          .enb(enb),
                          .in1_re(in1_re),  // sfix37_En22
                          .in1_im(in1_im),  // sfix37_En22
  ...
  DFT5_4_block2 u_DFT5_4 (.clk(clk),
                          .reset_x(reset_x),
                          .enb(enb),
                          .in1_re(in1_re),  // sfix37_En22
                          .in1_im(in1_im),  // sfix37_En22
  ...
  DFT5_5_block2 u_DFT5_5 (.clk(clk),
                          .reset_x(reset_x),
                          .enb(enb),
                          .in1_re(in1_re),  // sfix37_En22
                          .in1_im(in1_im),  // sfix37_En22
