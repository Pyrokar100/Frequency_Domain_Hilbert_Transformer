...
// 
// Module: W10
// Source Path: newhope_cambios/FDHT/DFT/DFT10 - block/W10
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module W10
  ...
  Complex_multiplication_block12 u_Complex_multiplication (.clk(clk),
                                                           .reset_x(reset_x),
                                                           .enb(enb),
  ...
  Complex_multiplication2_block7 u_Complex_multiplication2 (.clk(clk),
                                                            .reset_x(reset_x),
                                                            .enb(enb),
  ...
  Complex_multiplication3_block7 u_Complex_multiplication3 (.clk(clk),
                                                            .reset_x(reset_x),
                                                            .enb(enb),
  ...
  Complex_multiplication1_block7 u_Complex_multiplication1 (.clk(clk),
                                                            .reset_x(reset_x),
                                                            .enb(enb),
