...
// -------------------------------------------------------------
// 
// Module: save_values_real_G_x_0
// Source Path: newhope_cambios/FDHT/DFT/Save_data_G/save_values_real_G(x,0)
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module save_values_real_G_x_0
  ...
  reg  [0:3] delayMatch3_reg;  // ufix1 [4]
  wire [0:3] delayMatch3_reg_next;  // ufix1 [4]
  ...
  reg  [0:3] delayMatch4_reg;  // ufix1 [4]
  wire [0:3] delayMatch4_reg_next;  // ufix1 [4]
  ...
  assign Multiport_Switch13_out1_1 = delayMatch_reg[3];
  ...
  assign Multiport_Switch1_out1_1 = delayMatch1_reg[3];
  ...
  assign Multiport_Switch3_out1_1 = delayMatch2_reg[3];
  ...
  assign Multiport_Switch2_out1_1 = delayMatch3_reg[3];
  ...
  assign Multiport_Switch5_out1_1 = delayMatch4_reg[3];
...
endmodule  // save_values_real_G_x_0
