...
// -------------------------------------------------------------
// 
// Module: save_values_real_G_x_0_13
// Source Path: newhope_cambios/FDHT/DFT_2/save_G_values/save_values_real_G(x,0)13
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module save_values_real_G_x_0_13
  ...
  reg  [0:21] delayMatch_reg;  // ufix1 [22]
  wire [0:21] delayMatch_reg_next;  // ufix1 [22]
  ...
  reg  [0:21] delayMatch1_reg;  // ufix1 [22]
  wire [0:21] delayMatch1_reg_next;  // ufix1 [22]
  ...
  reg  [0:21] delayMatch2_reg;  // ufix1 [22]
  wire [0:21] delayMatch2_reg_next;  // ufix1 [22]
  ...
  reg  [0:21] delayMatch3_reg;  // ufix1 [22]
  wire [0:21] delayMatch3_reg_next;  // ufix1 [22]
  ...
  reg  [0:21] delayMatch4_reg;  // ufix1 [22]
  wire [0:21] delayMatch4_reg_next;  // ufix1 [22]
  ...
  assign Multiport_Switch4_out1_1 = delayMatch_reg[21];
  ...
  assign Multiport_Switch1_out1_1 = delayMatch1_reg[21];
  ...
  always @(posedge clk)
    begin : delayMatch2_process
      if (reset_x == 1'b1) begin
        ...
        delayMatch2_reg[20] <= 1'b0;
        delayMatch2_reg[21] <= 1'b0;
      end
      else begin
        if (enb) begin
  ...
  assign Multiport_Switch3_out1_1 = delayMatch2_reg[21];
  ...
  always @(posedge clk)
    begin : delayMatch3_process
      if (reset_x == 1'b1) begin
        ...
        delayMatch3_reg[20] <= 1'b0;
        delayMatch3_reg[21] <= 1'b0;
      end
      else begin
        if (enb) begin
  ...
  assign Multiport_Switch2_out1_1 = delayMatch3_reg[21];
  ...
  assign delayMatch3_reg_next[20] = delayMatch3_reg[19];
  assign delayMatch3_reg_next[21] = delayMatch3_reg[20];
  ...
  always @(posedge clk)
    begin : delayMatch4_process
      if (reset_x == 1'b1) begin
        ...
        delayMatch4_reg[20] <= 1'b0;
        delayMatch4_reg[21] <= 1'b0;
      end
      else begin
        if (enb) begin
  ...
  assign Multiport_Switch5_out1_1 = delayMatch4_reg[21];
  ...
  assign delayMatch4_reg_next[20] = delayMatch4_reg[19];
  assign delayMatch4_reg_next[21] = delayMatch4_reg[20];
...
endmodule  // save_values_real_G_x_0_13
