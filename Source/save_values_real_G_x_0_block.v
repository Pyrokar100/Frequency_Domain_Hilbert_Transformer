...
// -------------------------------------------------------------
// 
// Module: save_values_real_G_x_0_block
// Source Path: newhope_cambios/FDHT/DFT_2/save_G_values/save_values_real_G(x,0)
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module save_values_real_G_x_0_block
  ...
  reg  [0:15] delayMatch_reg;  // ufix1 [16]
  wire [0:15] delayMatch_reg_next;  // ufix1 [16]
  ...
  reg  [0:15] delayMatch1_reg;  // ufix1 [16]
  wire [0:15] delayMatch1_reg_next;  // ufix1 [16]
  ...
  reg  [0:15] delayMatch2_reg;  // ufix1 [16]
  wire [0:15] delayMatch2_reg_next;  // ufix1 [16]
  ...
  reg  [0:15] delayMatch3_reg;  // ufix1 [16]
  wire [0:15] delayMatch3_reg_next;  // ufix1 [16]
  ...
  reg  [0:15] delayMatch4_reg;  // ufix1 [16]
  wire [0:15] delayMatch4_reg_next;  // ufix1 [16]
  ...
  assign Multiport_Switch4_out1_1 = delayMatch_reg[15];
  ...
  assign Multiport_Switch1_out1_1 = delayMatch1_reg[15];
  ...
  assign Multiport_Switch3_out1_1 = delayMatch2_reg[15];
  ...
  assign Multiport_Switch2_out1_1 = delayMatch3_reg[15];
  ...
  assign Multiport_Switch5_out1_1 = delayMatch4_reg[15];
...
endmodule  // save_values_real_G_x_0_block
