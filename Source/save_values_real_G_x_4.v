...
// -------------------------------------------------------------
// 
// Module: save_values_real_G_x_4
// Source Path: newhope_cambios/FDHT/DFT/Save_data_G/save_values_real_G(x,4)
// Hierarchy Level: 3
// 
// -------------------------------------------------------------
...
module save_values_real_G_x_4
  ...
  reg  [0:7] delayMatch2_reg;  // ufix1 [8]
  wire [0:7] delayMatch2_reg_next;  // ufix1 [8]
  ...
  reg  [0:7] delayMatch3_reg;  // ufix1 [8]
  wire [0:7] delayMatch3_reg_next;  // ufix1 [8]
  ...
  assign Multiport_Switch13_out1_1 = delayMatch_reg[7];
  ...
  assign Multiport_Switch1_out1_1 = delayMatch1_reg[7];
  ...
  assign Multiport_Switch3_out1_1 = delayMatch2_reg[7];
  ...
  assign Multiport_Switch2_out1_1 = delayMatch3_reg[7];
  ...
  assign Multiport_Switch5_out1_1 = delayMatch4_reg[7];
...
endmodule  // save_values_real_G_x_4
