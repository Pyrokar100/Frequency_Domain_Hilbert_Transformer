...
// 
// Module: TWDLROM_5_1
// Source Path: FDHT_N/FDHT/DFT/TWDLROM_5_1
// Hierarchy Level: 2
// 
// -------------------------------------------------------------
...
module TWDLROM_5_1
  ...
  input   dout_4_1_vld;
  input   softReset;
  output  signed [14:0] twdl_5_1_re;  // sfix15_En13
  output  signed [14:0] twdl_5_1_im;  // sfix15_En13
  output  twdl_5_1_vld;
  ...
  reg  twdl45Reg;
  reg signed [14:0] twdl_5_1_re_1;  // sfix15_En13
  reg signed [14:0] twdl_5_1_im_1;  // sfix15_En13
  reg  twdl_5_1_vld_1;
  ...
  always @(Radix22TwdlMapping_cnt, Radix22TwdlMapping_phase,
       ...
       Radix22TwdlMapping_dvldReg1, Radix22TwdlMapping_dvldReg2, dout_4_1_vld) begin
    ...
    if (dout_4_1_vld && (Radix22TwdlMapping_cnt > 4'b1011)) begin
      Radix22TwdlMapping_phase_next = Radix22TwdlMapping_phase + 2'b01;
    end
    if (dout_4_1_vld) begin
      Radix22TwdlMapping_cnt_next = Radix22TwdlMapping_cnt + 4'b0100;
    end
